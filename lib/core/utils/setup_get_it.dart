...
void setupGetIt(){
  ...
  getIt.registerLazySingleton<GeminiSevice>(() => GeminiSevice(apiClient: getIt<ApiClient>()));
  getIt.registerLazySingleton<ChatRepo>(() => GeminiChatRepoImple(geminiSevice: getIt<GeminiSevice>()));


  getIt.registerFactory<ChatCubit>(() => ChatCubit(repo: getIt<ChatRepo>()));
}